 ...
 * @author cyrus
 */
public class StrategieSoldat implements StrategieCombattant{
    ...
    public void action(ChampDeBataille champ, Combattant c) {
         Ia ia = new Ia(champ);
           decision = ia.applicationDecisionSoldat(champ, c);
          System.out.println("Decision "+decision+" combattant soldat");
    ...
    public void combat1(ChampDeBataille champ,Combattant c){
    ...
    public void combat2(ChampDeBataille champ,Combattant combattant){
        ...
        if(combattant.getMinution()[2]>0){
          ...
          /* char direction='m';
            ...
            for(int i=0;i<champ.getTaille();i++){
                if(champ.getGrille()[c.getPosition().getX()+i][c.getPosition().getY()].getContenue() instanceof Mur){
                    bas = 100000;break;
                }else if(champ.getGrille()[c.getPosition().getX()+i][c.getPosition().getY()].getContenue() instanceof Combattant){
                    bas-=1;break;
                }else{
                    bas+=1;
                }
            ...
            for(int i=0;i<champ.getTaille();i++){
                if(champ.getGrille()[c.getPosition().getX()][c.getPosition().getY()+i].getContenue() instanceof Mur){
                    droite= 100000;break;
                }else if(champ.getGrille()[c.getPosition().getX()][c.getPosition().getY()+i].getContenue() instanceof Combattant){
                    droite-=1;break;
                }else{
                    droite+=1;
                }
